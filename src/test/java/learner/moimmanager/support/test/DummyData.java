...
public class DummyData {
    ...
    public final static Member DEFAULT_DB_MEMBER = new Member("김다윗", "소프트러너", "$2a$10$dfjoraNXdiAgcUsRp7sABO28xByV2EtjMUre2VGqUsLinHxw8Sfvi", "learner@soft.com", Grade.NORMAL);
