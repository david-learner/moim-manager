...
public class DummyData {
    ...
    public final static User DEFAULT_DB_LEADER = new User("황러너", "하드러너", "$2a$10$dfjoraNXdiAgcUsRp7sABO28xByV2EtjMUre2VGqUsLinHxw8Sfvi", "learner@hard.com", Grade.NORMAL);
    public final static User DEFAULT_DB_MEMBER = new User("김다윗", "소프트러너", "$2a$10$dfjoraNXdiAgcUsRp7sABO28xByV2EtjMUre2VGqUsLinHxw8Sfvi", "learner@soft.com", Grade.NORMAL);
